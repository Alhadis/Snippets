...
class Engraver{
	...
	/**
	 * Scale the edited image to the designated dimensions.
	 * 
	...
	/**
	 * Check if a file is of an image format PHP's able to manipulate.
	 * 
	...
	/**
	 * Draw a box over the engraver's source image.
	 * 
	...
	/**
	 * Write a line of text onto the source image using the current formatting settings.
	 * 
	...
	/**
	 * Display or save a copy of the edited image.
	 * 
