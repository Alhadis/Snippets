...
/** getComputedStyle */
window.getComputedStyle=window.getComputedStyle||function(t){if(!t)return null;var e=t.currentStyle,o=t.getBoundingClientRect(),l=document.createElement("div"),n=l.style;for(g in e)n[g]=e[g];n.cssFloat=n.styleFloat,"auto"===n.width&&(n.width=o.right-o.left+"px"),"auto"===n.height&&(n.height=o.bottom-o.top+"px");for(var i,r=n.cssText,s=r.split(/; /g),u=0,g=0,d=s.length;d>g;++g)(i=(s[g].split(/:/)||{})[0])&&(n[g]=i.toLowerCase(),++u);return n.length=u,n.cssText=r,n};
