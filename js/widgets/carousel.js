(function(){
	...
	Carousel = function(args){
		...
		/**
		 * Slide the carousel (hopefully smoothly) to the desired position.
		 * @param {Number} value
		 */
		...
		/** Slide the carousel to the previous cell situated off-screen. */
		back = function(wrap){
		...
		/** Slide the carousel to the next cell situated off-screen. */
		next = function(wrap){
